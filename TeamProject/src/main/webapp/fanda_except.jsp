...
<%	
	...
	ArrayList<FandaDto> exceptList = (ArrayList<FandaDto>)request.getAttribute("fandalist");
    ...
    <div class="lnb_box">
      <div class="lnb_content">
        ...
        <div class="category_box">
	        <ul>
		        <li><button id = "signup" class="" >회원가입</button></li>
		        <li><button id = "diary" class="">여행기 작성</button></li>
		        <li><button id = "plan" class="">여행 일정 작성</button></li>
		        <li><button id = "except" class="active">기타</button></li>
	        </ul>
	         <div style="clear:both"></div>
  		</div>
      ...
      <div id = "fanda_signup" class="show" >
        ...
        %>
	        <div class="fanda_main_box">
	        	...
	        	<div class="fanda_title fl"><%=exceptList.get(i).getFa()%></div>
	    ...
	    %>
	         		<div class="fanda_content_btn_box fr">
		         		...
		         		<div class="fanda_content_btn fl">
		         			<button id = "<%=exceptList.get(i).getFno()%>" class="fanda_update">수정</button>
		         			<button id = "<%=exceptList.get(i).getFno()%>" class="fanda_delete">삭제</button>
		         		</div>
	         		</div>
	    <%
	        };
	    %>
	         		<div class="fanda_content"><%=exceptList.get(i).getFq()%></div>
	   ...
	   %>
		...
		%>
		          <div class="page_btn">
		         	<div class="fl"><a href="Controller?command=fanda_except_list"><img src="resources/images/double_left.png"/></a></div>
		         	<%if(pageNum == 1){%>
		         	<div class="fl"><a href="Controller?command=fanda_except_list"><img src="resources/images/left_page.png"/></a></div>
		         	<% 
		         	}else{%>
		         	<div class="fl"><a href="Controller?command=fanda_except_list&pageNum=<%=pageNum-1%>"><img src="resources/images/left_page.png"/></a></div>
				    <% };
					...
					%>
					<a href= "Controller?command=fanda_except_list&pageNum=<%=i%>"><%=i%></a>	
					<%
						}
				    };
				    if(pageNum == totalPage){%>
		         	<div class="fl"><a href="Controller?command=fanda_except_list&pageNum=<%=pageNum%>"><img src="resources/images/right_page.png"/></a></div>
				   	<%}else{%>
		         	<div class="fl"><a href="Controller?command=fanda_except_list&pageNum=<%=pageNum+1%>"><img src="resources/images/right_page.png"/></a></div>
		         	<%}; %>
		         	<div class="fl"><a href="Controller?command=fanda_except_list&pageNum=<%=totalPage%>"><img src="resources/images/double_right.png"/></a></div>
			        <div style="clear:both"></div>
		         </div>
		 <div style="clear:both"></div>
		</div> 
