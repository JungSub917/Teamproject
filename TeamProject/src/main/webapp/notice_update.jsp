...
<link rel="stylesheet" href="folder/css/notice.css">
<link rel="stylesheet" href="folder/css/header_footer.css">
<script src="js/jquery-3.7.0.min.js"></script>
<script type="text/javascript" src="smarteditor/js/HuskyEZCreator.js" charset="utf-8"></script>
<script src="folder/js/Stubby.js"></script>
<script type="text/javascript" src="./folder/js/header_footer.js"></script>
	</head>
	<body>
    <header>
    <div class="head_box">
...
<form action="Controller" method="POST">
  <div class="notice_write_box border">
    <div>제목<sup>*</sup></div>
    <div class="notice_write_title">
      <input id = "title" type="text" name="title" value = "<%=nDto.getTitle()%>"/>
      <input type="hidden" name = "command" value = "notice_update_Input"/>
      <input id = "nno" type="hidden" name = "nno" value = "<%=nDto.getNno()%>"/>
    </div>
    <div style="clear:both"></div>
    ...
    <div class= "notice_write_content">
      <div>내용<sup>*</sup></div>
      <div style="clear:both"></div>
      <textarea id="txtContent" rows="10" cols="100" name="content"><%=nDto.getContent() %></textarea>
      <script type="text/javascript">
        ...
        function save() {
          ...
          location.href = "Controller?command=notice_update_input&nno="+nno+"&title="+title+"&content="+content;
          alert("해당 글이 수정되었습니다.");
          return;
        }
      </script>
    ...
    <div class="notice_writeBtn_box fr">
      <input type="button" value="취소" onclick="location.href='Controller?command=notice_detail&nno='+<%=nDto.getNno()%>;" />
